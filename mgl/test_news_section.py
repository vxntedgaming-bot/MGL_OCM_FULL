...
class NewsSectionTests(TestCase):
    ...
    def test_news_routes_and_nav_only_have_two_destinations(self):
        ...
        self.assertContains(activity, "Live feed of results, transfers and signings across all leagues.")
        self.assertContains(activity, "No league activity yet.")
        self.assertContains(activity, "New results, transfers and signings will appear here.")
