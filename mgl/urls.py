...
urlpatterns = [
    ...
    path("control/recruitment/", views_control.control_recruitment, name="control_recruitment"),
    path("control/scout-config/", views_control.control_scout_config, name="control_scout_config"),
