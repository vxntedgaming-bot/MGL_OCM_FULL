...
class ManagerHubDashboardTests(TestCase):
    ...
    def test_club_manager_sees_dashboard_structure(self):
        ...
        self.assertContains(response, "mgl-notify-count")
        ...
        self.assertContains(response, "/market/youth-academy/")
    ...
    def test_manager_without_club_sees_empty_states_and_jobs(self):
        ...
        self.assertContains(response, 'class="ufl-coin-amt">20.00</span>')
