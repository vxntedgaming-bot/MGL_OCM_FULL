...
class Command(BaseCommand):
    ...
    def handle(self,*args,**opts):
        ...
        Player.objects.update(mgl_team=None,is_free_agent=True,appearances=0,goals=0,assists=0,average_rating=0,released_at=None)
        ...
        self.stdout.write(self.style.SUCCESS("MGL reset complete. FC players remain as free agents. Create leagues/teams through Admin."))
