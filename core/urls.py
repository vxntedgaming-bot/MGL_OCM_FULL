...
urlpatterns = [
    ...
    path("leagues/all/", leagues_page, name="leagues_all"),
    path("leagues/<slug:slug>/", competition_page, name="competition_page"),
    path("cups/", competition_page, {"slug": "cups"}, name="cups_hub"),
    path("cups/<slug:slug>/", competition_page, name="cups_detail"),
    path("clubs/", clubs_index, name="clubs_index"),
    path("clubs/<str:slug>/", club_page, name="club_page_clubs"),
    path("teams/<str:slug>/", club_page, name="club_page"),
    ...
    path("market/players/", player_database, name="market_players_alias"),
    path("market/free-agents/", free_agents, name="market_free_agents_alias"),
    path(
        "market/auctions/",
